...
describe("validate function should", () => {
  ...
  it("return false when person without name", () => {
    const person = { age: 12 };
    const [isValid, info] = functions.validate(person);
    expect(isValid).toBeFalsy();
    expect(info).toBe(messages.NAME_OR_AGE_NOT_DEFINED);
  ...
  it("return false when person with name and age equals 0", () => {
  ...
  it("return false when person with name and age less than 0", () => {
...
describe("findMatches function should", () => {
  it("return all words that matches", () => {
    const toFind = "a";
  ...
  it("return empty array if nothing matches", () => {
    const toFind = "a";
  ...
  it("return empty array if toSearch array is empty", () => {
    const toFind = "a";
    const toSearch = [];
    const received = functions.findMatches(toFind, toSearch);
    const expected = [];
  ...
  it("return empty array if toFind word is empty", () => {
    const toFind = "";
    const toSearch = [{ name: "b" }, { name: "c" }];
    const received = functions.findMatches(toFind, toSearch);
    const expected = [];
